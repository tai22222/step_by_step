...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'project.category' => 'カテゴリー',
        'project.content' => 'プロジェクトの内容',
        'steps.0.title' => 'ステップのタイトル',
        'steps.0.content' => 'ステップの内容',
        'steps.0.estimated_time' => '目安達成時間',
        'steps.1.title' => 'ステップのタイトル',
        'steps.1.content' => 'ステップの内容',
        'steps.1.estimated_time' => '目安達成時間',
        'steps.2.title' => 'ステップのタイトル',
        'steps.2.content' => 'ステップの内容',
        'steps.2.estimated_time' => '目安達成時間',
        'steps.3.title' => 'ステップのタイトル',
        'steps.3.content' => 'ステップの内容',
        'steps.3.estimated_time' => '目安達成時間',
        'steps.4.title' => 'ステップのタイトル',
        'steps.4.content' => 'ステップの内容',
        'steps.4.estimated_time' => '目安達成時間',
        'steps.5.title' => 'ステップのタイトル',
        'steps.5.content' => 'ステップの内容',
        'steps.5.estimated_time' => '目安達成時間',
        'steps.6.title' => 'ステップのタイトル',
        'steps.6.content' => 'ステップの内容',
        'steps.6.estimated_time' => '目安達成時間',
        'steps.7.title' => 'ステップのタイトル',
        'steps.7.content' => 'ステップの内容',
        'steps.7.estimated_time' => '目安達成時間',
        'steps.8.title' => 'ステップのタイトル',
        'steps.8.content' => 'ステップの内容',
        'steps.8.estimated_time' => '目安達成時間',
        'steps.9.title' => 'ステップのタイトル',
        'steps.9.content' => 'ステップの内容',
        'steps.9.estimated_time' => '目安達成時間',
        'steps.10.title' => 'ステップのタイトル',
        'steps.10.content' => 'ステップの内容',
        'steps.10.estimated_time' => '目安達成時間',
    ],
